...
def index(pagina=1):
    ...
    return render_page(render_template_string(content, videos=videos_pagina, pagina=pagina, total_paginas=total_paginas), 
                      ...
                      description="Galeria paginada de vídeos com descrição")
...
def admin():
    ...
    '''
    return render_page(render_template_string(content, videos=videos), title="Painel Admin", description="Gerenciar vídeos")
